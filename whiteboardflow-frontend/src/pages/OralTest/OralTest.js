...
function OralTest() {
	...
	return (
		...
		<CircularProgress color="inherit" />
                    ...
                    <Paper elevation={3} style={{ marginBottom: "40px", padding: '20px', borderRadius: '10px', backgroundColor: darkMode ? '#202124' : '#fff', height: '100%', display: 'flex', flexDirection: 'column' }}>
